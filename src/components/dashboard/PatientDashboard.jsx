...
export function PatientDashboard({ userName = "John" }) {
  ...
  const stats = [
    { label: "Upcoming Appointments", value: "3", icon: Calendar, color: "#4F46E5" },
          ...
          {doctors.map((doctor, index) => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 bg-gradient-to-br from-[#4F46E5] to-[#6366F1] rounded-xl flex items-center justify-center text-white flex-shrink-0" style={{ fontSize: '16px', fontWeight: 600 }}>
                  {doctor.avatar}
                </div>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 mt-4">
                    <button
                      ...
                      className="flex-1 bg-[#4F46E5] text-white py-2.5 px-4 rounded-lg hover:bg-[#4338CA] transition-colors"
                  ...
                  <div className="flex items-center gap-2 mt-3">
                    <div className={`w-2 h-2 rounded-full ${doctor.available ? 'bg-[#10B981]' : 'bg-[#EF4444]'}`}></div>
                    <span style={{ fontSize: '13px', color: '#6B7280' }}>
